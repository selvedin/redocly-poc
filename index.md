...
* ![Get started image](./images/get-started.png)
{% /table %}
***
...
{% card title="" layout="vertical" align="center" variant="outlined" %}
...
{% card title="" layout="vertical" variant="outlined"  %}

{% table %}
---
* {% img src="./images/loc.png" alt="Description of image" width="20" height="20" /%}
